# Specification: Auth Hardening (Forgot Password & Session Persistence)

## Capability Summary
Forgot-password hoạt động rõ ràng trong dev (link hiển thị) và gửi email trong prod; session đăng nhập persist khi đóng/mở lại browser với Remember me.
